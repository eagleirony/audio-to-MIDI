...
// defines
#define AXI_REGS_BASE                 0xA0000000
...
void init_axi_dma(int fft, int feedback) {
    ...
    Xil_Out32(AXI_REGS_BASE + AXI_I2S_CTR_OFFSET, i2s_ctr);
    printf("Setting AXI transfer length to %d\n", FFT_SIZE);
    Xil_Out32(AXI_REGS_BASE + AXI_AXI_CTR_OFFSET, axi_ctr);
    print_regs();
...
void print_regs() {
    printf("   Bitfile Version: 0x%08x\n", Xil_In32(AXI_REGS_BASE + AXI_VERSION_OFFSET));
    printf("       I2S Control: 0x%08x\n", Xil_In32(AXI_REGS_BASE + AXI_I2S_CTR_OFFSET));
    printf("       AXI Control: 0x%08x\n", Xil_In32(AXI_REGS_BASE + AXI_AXI_CTR_OFFSET));
    printf("       FIFO Status: 0x%08x\n", Xil_In32(AXI_REGS_BASE + AXI_FIFO_STATUS_OFFSET));
    printf("        FFT Status: 0x%08x\n", Xil_In32(AXI_REGS_BASE + AXI_FFT_STATUS_OFFSET));
    printf("AXIS master Status: 0x%08x\n", Xil_In32(AXI_REGS_BASE + AXI_AXIS_MASTER_OFFSET));
}
...
void check_btn() {
    uint32_t curr_btn = Xil_In32(AXI_REGS_BASE + AXI_FFT_STATUS_OFFSET);
